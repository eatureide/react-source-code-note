...
},{}],"react-dom/setAttribute.js":[function(require,module,exports) {
"use strict";
...
function setAttribute(dom, key) {
  var value = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
  // 如果key是className
  var isClassName = key === 'className'; // 如果key是事件并且是函数

  var isEvent = /on\w+/.test(key) && typeof value === 'function'; // 如果key是样式style

  var isStyle = key === 'style'; // 转换为class
...
var _setAttribute = _interopRequireDefault(require("./setAttribute"));
...
function render(vnode, container) {
  ...
  var childrensIsArray = Array.isArray(childrens);
  var dom = document.createElement(tag); // 检查attrs，遍历该对象，并使用setAttribute方法设置dom属性

  if (attrs) {
    Object.keys(attrs).forEach(function (key) {
      var value = attrs[key];
      (0, _setAttribute.default)(dom, key, value);
    });
  }
...
exports.default = _default;
},{"./setAttribute":"react-dom/setAttribute.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var ele = _react.default.createElement("h1", {
  title: "react",
  className: "title",
  style: {
    color: 'blue'
...
//# sourceMappingURL=/react-source-code-example.e31bb0bc.js.map